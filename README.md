...
The UI is React with Tailwind CSS, and the components, game models, game logic and server methods are
TypeScript. The app is written as ES modules throughout and compiled with Meteor's modern build stack — Rspack for bundling, SWC for transpilation and minification, PostCSS for Tailwind.
...
- modernize the codebase and update dependencies (done — the Blaze/Bootstrap UI layer, the last part, moved to React and Tailwind in September 2026)
- stabilize gameplay
- run in docker
