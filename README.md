...
It uses Blaze for templating, React for the accounts menu, and TypeScript for the game models, game logic and server
methods. The app is written as ES modules throughout and compiled with Meteor's modern build stack — Rspack for bundling, SWC for transpilation and minification.
...
- modernize the codebase and update dependencies (done, except the Blaze/Bootstrap UI layer, which is being moved to React and is the last part still in plain JavaScript)
- stabilize gameplay
- run in docker
