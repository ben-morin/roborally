...
// each one starts with `import './config.js'` — that import is the load-order rule, not
// tidiness.
//
...
// entry points also import this module high up, next to `both/easySchemaConfig.js`, which
