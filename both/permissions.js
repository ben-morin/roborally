...
// as written. `Accounts.onCreateUser` in server/accounts.js stores the result as
...
export function displayNameFromEmail(address) {
...
// backfill in server/accounts.js retires it for existing users.
